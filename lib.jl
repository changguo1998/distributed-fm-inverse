...
LOG_SERVER_UNPACK() = abspath(PRJ_ROOT_PATH, "log/server_unpack.log")
LOG_SERVER_INVERSE() = abspath(PRJ_ROOT_PATH, "log/server_inverse.log")
LOG_SERVER_RESULT() = abspath(PRJ_ROOT_PATH, "log/server_result.log")
LOG_SERVER_UNPACK(svr::InvServer) = abspath(svr.system_root, "log/server_unpack.log")
LOG_SERVER_INVERSE(svr::InvServer) = abspath(svr.system_root, "log/server_inverse.log")
LOG_SERVER_RESULT(svr::InvServer) = abspath(svr.system_root, "log/server_result.log")
